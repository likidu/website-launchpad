...
export const metadata: Metadata = {
  ...
  description:
    'Stop midnight maintenance. TiDB’s online DDL keeps reads/writes live, so schema changes ship at lunch—no toolchain chaos, no lock drama. Try TiDB today.',
  robots: { index: true, follow: true },
  alternates: {
    canonical: 'https://www.pingcap.com/playbook/schema-changes-midnight-maintenance/',
  },
  openGraph: {
    title: 'Playbook: End 2 A.M. Schema Changes with TiDB Online DDL',
    description:
...
const schema = buildPageSchema({
  ...
  breadcrumbs: [
    { name: 'Home', path: '/' },
    {
      name: 'MySQL Schema Change at Lunch, Not 2 A.M.',
      path: '/playbook/schema-changes-midnight-maintenance/',
    },
  ],
})
  ...
  sections: [
    ...
    },
    {
      ...
      props: {
        title: '',
        subtitle:
          'Stop scheduling 2 A.M. maintenance. Ship schema changes at lunch with TiDB online DDL.',
        primaryCta: {
          text: 'Start Free Trial',
          href: 'https://tidbcloud.com/free-trial/',
        },
